...
let num = 0;
let qtd_perg = 0 
let total_perg = randomNumberInterval(6, 9); //------------Sorteia o número de perguntas no intervalo.
let msg = document.getElementById("msgBV")
let login = document.getElementById("login")
function responder(prp){// -----------------Avaliação da resposta

    qtd_perg += 1;   
    if (prp === botao_acerto){
        soma_acerto = soma_acerto + 1 
        document.getElementById('soma_acerto').innerText = soma_acerto + "/" + soma_erro
    ...
    if(qtd_perg < total_perg){
        ...
        document.getElementById('resultado').innerText = "Você acertou " + soma_acerto + " perguantas de " + total_perg + ".";
        finalizarquestao()
    }
}
//================================================================================ início
